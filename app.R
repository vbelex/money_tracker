      ...
      column(
        ...
        wellPanel(
          ...
          selectInput(
            ...
            choices = c("Groceries", "Rent", "Savings", "Online Dining", "Online Groceries", "Utilities", "Transport", "Dining", "Health", "Education", "Shopping", "Entertainment", "EMI", "Credit Card Bill", "Other"),
            selected = "Groceries"
          ),
